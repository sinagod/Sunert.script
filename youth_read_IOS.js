...
let ReadArr = [], YouthBody = "",readscore = 0;
  if (process.env.YOUTH_READ_IOS && process.env.YOUTH_READ_IOS.indexOf('&') > -1) {
  YouthBody = process.env.YOUTH_READ_IOS.split('&');
  console.log(`您选择的是用"&"隔开\n`)
  }
  else if (process.env.YOUTH_READ_IOS && process.env.YOUTH_READ_IOS.indexOf('\n') > -1) {
  YouthBody = process.env.YOUTH_READ_IOS.split('\n');
